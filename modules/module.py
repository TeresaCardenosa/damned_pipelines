...
import requests
import pandas as pd
import re         # (REGEX) Verifica que la estructura de la pull request está bien, el nombre del lab está bien hecho
import json
import math
...
USERNAME = 'TeresaCardenosa'             #USERNAME
...
# Primera parte: acquisition > data de donde sale
...
# Segunda parte: wrangling > limpieza de datos
...
# Tercera parte > analysis: aplicar métodos para llegar al resultado 
